...
const myObject = {
  ...
  property: "Kamran Tissory",

  outerMethod: function () {

    console.log("\n", this.property); // Works as expected, logs "Value"

    const innerMethod = () => {

      console.log("\n", this.property); // Still accesses myObject's 'property' due to arrow function capturing 'this' from outer scope
    };
