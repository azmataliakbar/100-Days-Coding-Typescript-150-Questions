...
const traditionalVsArrow = {
  ...
  arrowFunction: () => {
    console.log("\nArrow function:", this.value); // 'this' is not bound to traditionalVsArrow object but to the scope in which traditionalVsArrow was defined
  },
};
...
/* const traditionalVsArrow = {
  value: "traditionalVsArrow value.",
  traditionalFunction: function () {
    console.log("\nTraditional function:", this.value);
  }
}
...
/* const traditionalVsArrow = {
  value: "traditionalVsArrow value.",
  arrowFunction: () => {
    console.log("\nArrow function:", traditionalVsArrow.value);
    // if we use this.value, it shows error
  }
};
