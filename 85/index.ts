...
console.log("\n", findCodePosition("Learn to code with JavaScript")); // Outputs the start position of "code"
//? It tells us the position number where "code" starts, L is 0 then code is at position 9.